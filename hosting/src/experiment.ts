...
/* define instructions for training trials*/
 var instructions0 = {
  ...
  stimulus: `
    ...
    <p>If the likelier image is on the left, press the left arrow <i class="material-icons">&#xe314;</i> on the keyboard as fast as you can. If the likelier image is on the right, press the right arrow <i class="material-icons" style="font-size:36px">keyboard_arrow_right</i> as fast as you can.</p>
    <center>
